...
jQuery(document).ready(function($) {
    ...
    var int=self.setInterval(setbackground,5000);
    ...
    var current_spot = 0;
    var images_lists = ['/geo/assets/bg/1.jpg',
				'/geo/assets/bg/2.jpg',
				'/geo/assets/bg/3.jpg',
				'/geo/assets/bg/4.jpg',
				'/geo/assets/bg/5.jpg',
	...
	{
		jQuery('#header').css('background-image','url("'+images_lists[current_spot]+'")');
		current_spot++;
		if(current_spot >= images_lists.length)
		{
			current_spot = 0;
		}
	}
